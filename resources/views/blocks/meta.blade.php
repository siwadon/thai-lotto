...
<meta name="description" content="ตรวจหวย ตรวจสลากกินแบ่งรัฐบาล งวดวันที่ {{ $prizes['date']['human'] }} เลขที่ออก รางวัลที่หนึ่ง {{ $prizes['prizes']['first'][0] }} - เลขท้ายสามตัว {{ implode(', ', $prizes['prizes']['last_three_digits']) }} - เลขท้ายสองตัว {{ $prizes['prizes']['last_two_digits'][0] }}" />
